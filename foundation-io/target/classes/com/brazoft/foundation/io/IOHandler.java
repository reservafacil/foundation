...
public class IOHandler
{
	 ...
	 * @throws IOException
	 */
	public static File newTemp(String prefix) throws IOException
	{
	 ...
	 * @throws IOException
	 */
	public static byte[] readSerial(InputStream is) throws IOException
	{
	 ...
	 * @throws IOException
	 */
	public static byte[] readSerialAsChar(InputStream is) throws IOException
	{
		int character;
		StringBuffer buffer;
	 ...
	 * @throws IOException
	 */
	public static void write(OutputStream output, InputStream is) throws IOException
	{
		byte[] buffer;
		int len;
	 ...
	 * @throws IOException
	 */
	public static void writeObject(Object o, File f) throws IOException
	{
	 ...
	 * @throws IOException
	 */
	public static void writeObject(Object o, OutputStream output) throws IOException
	{
	 ...
	 * @throws IOException
	 */
	public static byte[] gunzip(File input) throws IOException
	{
	 ...
	 * @throws IOException
	 */
	public static void zip(File output, File root, File[] files) throws IOException
	{
		ZipOutputStream zip;
	 ...
	 * @throws IOException
	 */
	public static void unzipAll(File root, File zip) throws IOException
	{
	 ...
	 * @throws IOException
	 */
	public static long generateMD5(File file) throws IOException
	{
