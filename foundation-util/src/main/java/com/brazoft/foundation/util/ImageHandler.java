...
public class ImageHandler {
     ...
     * @throws IOException
     */
    public static BufferedImage createRGBImage(byte[] data)
	throws IOException {
     ...
     * @throws IOException
     */
    public static void write(RenderedImage image, String path)
	throws IOException {
     ...
     * @throws IOException
     */
    public static void write(RenderedImage image, File path)
	throws IOException {
     ...
     * @throws IOException
     */
    public static void write(RenderedImage image, OutputStream output)
	throws IOException {
