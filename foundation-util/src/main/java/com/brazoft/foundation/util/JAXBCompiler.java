...
public class JAXBCompiler {
    ...
    public static Unmarshaller createUnmarshaller(String packageImpl)
	throws Exception {
	return JAXBContext.newInstance(packageImpl).createUnmarshaller();
    }

    public static Marshaller createMarshaller(String packageImpl, String encoding)
	throws Exception {
	Marshaller m;
    ...
    public static Object compile(String xml, String packageImpl)
	throws Exception {
	return JAXBCompiler.createUnmarshaller(packageImpl).unmarshal(new ByteArrayInputStream(xml.getBytes()));
    }

    public static Object compile(InputStream xml, String packageImpl)
	throws Exception {
	return JAXBCompiler.createUnmarshaller(packageImpl).unmarshal(xml);
    }

    public static Object compile(File xml, String packageImpl)
	throws Exception {
	return JAXBCompiler.compile(new FileInputStream(xml), packageImpl);
    }

    public static void serialize(Object object, File file, String packageImpl)
	throws Exception {
	JAXBCompiler.serialize(object, new FileOutputStream(file), packageImpl);
    }

    public static void serialize(Object object, OutputStream output, String packageImpl)
	throws Exception {
	JAXBCompiler.serialize(object, output, packageImpl, "UTF-8");
    }

    public static void serialize(Object object, OutputStream output, String packageImpl, String encoding)
	throws Exception {
	JAXBCompiler.createMarshaller(packageImpl, encoding).marshal(object, output);
    }

    public static void serialize(Object object, Document output, String packageImpl, String encoding)
	throws Exception {
	JAXBCompiler.createMarshaller(packageImpl, encoding).marshal(object, output);
    }
