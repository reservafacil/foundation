...
public class VelocityUtil
{
	...
	public InputStream merge(VelocityContext context, org.apache.velocity.Template template) throws Exception
	{
		return new StringInputStream(this.toString(context, template));
	}

	public String toString(VelocityContext context, org.apache.velocity.Template template) throws Exception
	{
		StringWriter writer;
