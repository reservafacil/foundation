...
public class DateTimeUtil
{
	 ...
	 * @param calendar
	 * @param toCompare
	 * @return Returns if calendar is less than toCompare using Year, Month and Date, ignoring after all
	 */
	 ...
	 * @param calendar
	 * @param toCompare
	 * @return Returns if calendar is more than toCompare using Year, Month and Date, ignoring after all
	 */
