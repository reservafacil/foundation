...
public class JDBCUtil
{
	 ...
	 * @throws SQLException
	 */
	public static boolean isPostgre(Connection connection) throws SQLException
	{
	 ...
	 * @throws SQLException
	 */
	protected static String getDatabaseName(Connection connection) throws SQLException
	{
