...
public class JSArrays {
	...
	/**
	 * Reverses the sequence of the array's elements and returns the array. This method modifies the original array.
	...
	/**
	 * Return a sub-array starting a the given index and ending with the last element in the given array.
	 ...
	 * @param a The array to extract from.
	 * @param pos The position of the first element to extract.
	 * @param last If positive, the index of the element which follow the last element to extract.
	...
	/**
	 * Remove <code>nrepl</code> elements starting at the given position and afterwards insert an object at the same position.
	...
	/**
	 * Remove <code>nrepl</code> elements starting at the given position and afterwards insert two objects at the same position.
	...
	/**
	 * Remove <code>nrepl</code> elements starting at the given position and afterwards insert three objects at the same position.
