...
import com.brazoft.foundation.gwt.client.util.Objects;
...
public class Slider extends Bootstrap<Slider> implements UIInput<Slider, Double>, ResponsiveComponent<Slider>
{
	...
	void updatePlaceHolder(String placeholder)
	{
		...
		String message = Objects.format(placeholder, values);
    ...
    private native void createSliderJS(Slider x, String id, JavaScriptObject options) /*-{
        options.start = function(event, ui) {
            x.@com.brazoft.foundation.gwt.client.ui.Slider::fireOnStartEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayNumber;)(event, ui.values);
        };
        options.slide = function(event, ui) {
            return x.@com.brazoft.foundation.gwt.client.ui.Slider::fireOnSlideEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayNumber;)(event, ui.values);
        };
        options.change = function(event, ui) {
            var has = event.originalEvent ? true : false;
            x.@com.brazoft.foundation.gwt.client.ui.Slider::fireOnChangeEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayNumber;Z)(event, ui.values, has);                
        };
        options.stop = function(event, ui) {
            x.@com.brazoft.foundation.gwt.client.ui.Slider::fireOnStopEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayNumber;)(event, ui.values);
        };
