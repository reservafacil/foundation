...
import com.brazoft.foundation.gwt.client.ui.Heading;
import com.brazoft.foundation.gwt.client.ui.Paragraph;
import com.brazoft.foundation.gwt.client.ui.Table;
...
public abstract class DataPanel<D extends DataPanel<D>> extends Component<D>
{
	...
	public DataPanel(int columns)
	{
		...
		this.className("data-panel").init(columns);
	}
	...
	{
		this.cell(this.columns).add(widget);
