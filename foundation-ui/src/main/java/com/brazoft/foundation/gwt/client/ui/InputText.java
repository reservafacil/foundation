...
public class InputText extends Input<InputText, String>
{
	...
	public InputText typeahead(JSONCollection<?> values)
	{
		return this.attribute("data-source", values.toString()).attribute("data-provide", "typeahead");
	}
	
	public InputText typeahead(JSONCollection<?> values, int showItems)
	{
