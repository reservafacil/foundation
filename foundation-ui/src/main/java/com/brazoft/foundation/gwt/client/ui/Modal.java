...
public class Modal extends NativeEvent<Modal>
{
	...
	public Modal()
	{
		...
		this.id(id).className("modal hide fade in").attribute("role", "dialog")
			.attribute("aria-labelledby", id + "_label").attribute("aria-hidden", "true")
			.attribute("data-keyboard", "true");
	}
	...
	{
		return new Button(ButtonOptions.ANCHOR).attribute("href", "#" + this.getId()).attribute("role", "button").attribute("data-toggle", "modal").text(label);
	}
	...
	public static class ModalBody extends Bootstrap<ModalBody>
	{
		public ModalBody()
		{
			super(ElementResolver.div());
	...
	public static class ModalFooter extends Bootstrap<ModalFooter>
	{
		public ModalFooter()
		{
			super(ElementResolver.div());
	...
	public static class ModalHeader extends Bootstrap<ModalHeader> implements HasText<ModalHeader>
	{
