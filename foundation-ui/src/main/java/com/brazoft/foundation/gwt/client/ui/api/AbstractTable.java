...
public class AbstractTable<T extends AbstractTable<T>> extends Bootstrap<T>
{
	...
	public static class Caption extends Bootstrap<Caption> implements HasText<Caption>
	{
		public Caption()
		{
	...
	public static class Header extends Bootstrap<Header>
	{
		public Header()
		{
	...
	public static class Footer extends Bootstrap<Footer>
	{
		public Footer()
		{
	...
	public static class Body extends Bootstrap<Body>
	{
		public Body()
		{
	...
	public static class Row extends Bootstrap<Row> implements HasClickHandlers<Row>, HasMouseHandlers<Row>
	{
		...
		public static class Cell extends Bootstrap<Cell> implements HasText<Cell>, HasClickHandlers<Cell>, HasMouseHandlers<Cell>
		{
