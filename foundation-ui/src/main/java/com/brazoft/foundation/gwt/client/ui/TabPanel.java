...
public class TabPanel extends Bootstrap<TabPanel>
{
	...
	private void init(Direction direction)
	{
		...
		switch(direction)
		{
			case BOTTOM: this.className("tabs-below"); break;
			case LEFT: this.className("tabs-left"); break;
			case RIGHT: this.className("tabs-right"); break;
			default: break;
		}
