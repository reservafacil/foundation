...
public abstract class Select<S extends Select<S, V>, V>
    extends Bootstrap<S>
    implements UIInput<S, V>, HasFocusHandlers<S>, HasChangeHandlers<S>, HasKeyHandlers<S>, HasMouseHandlers<S>// ,
// ResponsiveComponent<S>
{
