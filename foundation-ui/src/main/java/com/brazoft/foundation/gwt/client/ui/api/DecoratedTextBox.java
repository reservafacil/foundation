...
import com.brazoft.foundation.gwt.client.ui.TextBox;
...
public abstract class DecoratedTextBox<D extends DecoratedTextBox<D, V>, V> extends Bootstrap<D> implements UIInput<D, V>, HasKeyHandlers<D>, HasFocusHandlers<D>, HasMouseHandlers<D>, HasChangeHandlers<D>, ResponsiveComponent<D>
{
	...
	public D typeahead(JSONArray values)
	{
		this.input.attribute("data-source", values.toString()).attribute("data-provide", "typeahead");
		return (D) this;
	}
	
	public D typeahead(JSONArray values, int showItems)
	{
	...
	public D mask(String placeholder, String pattern)
	{
		this.input.mask(pattern, placeholder);
		return (D) this;
	}
	
	public D typeahead(JSONCollection<?> values)
	{
		this.input.typeahead(values);
		return (D) this;
	}
	
	public D typeahead(JSONCollection<?> values, int showItems)
	{
