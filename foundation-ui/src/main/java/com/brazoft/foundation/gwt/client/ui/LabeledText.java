...
public class LabeledText extends Bootstrap<LabeledText> implements HasText<LabeledText>
{
	private StyleChooser<LabeledText> chooser = new StyleChooser<LabeledText>("label-success", "label-warning", "label-important", "label-info", "label-inverse");
