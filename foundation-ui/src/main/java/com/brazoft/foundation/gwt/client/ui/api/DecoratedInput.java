...
public abstract class DecoratedInput<D extends DecoratedInput<D, V>, V> extends Bootstrap<D> implements UIInput<D, V>, HasKeyHandlers<D>, HasFocusHandlers<D>, HasMouseHandlers<D>, HasChangeHandlers<D>, ResponsiveComponent<D>
{
	...
	public DecoratedInput(Input<?, V> input)
	{
