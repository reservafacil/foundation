 ...
 */
public class LoopTrigger extends AbstractTrigger
{
	...
	{
		return new SimpleTrigger(super.getJobRegistry().getId(), super.getJobRegistry().getGroupId(), super.getSchedule().getTime(), null, SimpleTrigger.REPEAT_INDEFINITELY, this.loopInterval);
	}
}